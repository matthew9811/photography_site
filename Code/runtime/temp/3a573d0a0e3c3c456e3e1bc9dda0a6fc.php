<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"F:\photography_site\Code\public/../application/index\view\admin\check_blog.html";i:1551549163;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="container blog_container">
    ...
    <div class="blog_comment">
        ...
        <div class="check_button">
            <button type="button" class="btn btn-info">posting</button>&nbsp;&nbsp;&nbsp;
